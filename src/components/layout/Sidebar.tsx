...
import { Bell, ChevronUp, LayoutDashboard, Users, Kanban, History, Send, FileSignature, Newspaper, Settings, Shield, LogOut, Eye } from 'lucide-react';
...
export function Sidebar() {
  ...
  const navItems = viewingId
    ...
    : [
        ...
        ...(isOverseer ? [{ to: '/blog', label: 'Blog', icon: Newspaper }] : []),
