...
import { Bell, ChevronUp, LayoutDashboard, Users, Kanban, History, Send, FileSignature, Inbox, Settings, Shield, LogOut, Eye } from 'lucide-react';
...
export function Sidebar() {
  ...
  const navItems = viewingId
    ...
    : [
        ...
        ...(isOverseer ? [{ to: '/envelopes', label: 'Envelopes', icon: Inbox }] : []),
